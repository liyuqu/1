...
public class AsyncInferenceRequest
        extends RichAsyncFunction<float[][][][], Tuple4<String, Long, Long,float[][][][]>> {
    ...
    public AsyncInferenceRequest(String url1) throws Exception {
        // Create a neat value object to hold the URL
        this.url1 = new URL(url1);
    }

    @Override
    public void asyncInvoke(float[][][][] inputBatch,
                            ResultFuture<Tuple4<String, Long, Long,float[][][][]>> resultFuture) throws Exception {
